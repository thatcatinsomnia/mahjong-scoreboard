<template>
  <div class="flex relative items-center">
    ...
    <div class="p-1 flex-1 flex">
      <input class="p-2 flex-1 outline-none focus:ring-2 focus:ring-green-500 hover:bg-gray-200" type="text" :value="player.score" @input="updateScore($event, player.name)" />
    </div>
